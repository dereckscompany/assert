---
title: "Demonstrating assert"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Demonstrating assert}
...
This vignette demonstrates the two main functions in `assert`:
...
```{r setup}
box::use(assert[ add, sum_array_cpp ])
```
