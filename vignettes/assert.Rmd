...
A scalar-character check accepts any single string, including the empty string `""`. When an empty value is never valid — identifiers, codes, keys — add `non_empty = TRUE`.

```{r non-empty, error=TRUE}
box::use(assert[assert_scalar_character])
