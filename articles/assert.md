...
The examples below import the functions they use with
`box::use(assert[...])`, so it is always clear where each function comes
from. If you prefer,
[`library(assert)`](https://dereckscompany.github.io/assert) works too.
