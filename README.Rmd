...
`assert_scalar_character()` accepts any single string, including `""`. For arguments such as identifiers or codes where an empty value is never valid, pass `non_empty = TRUE`:
...
> Mezquita, D. (2026). assert. https://github.com/dereckscompany/assert. ORCID: [0000-0002-9307-6762](https://orcid.org/0000-0002-9307-6762)
