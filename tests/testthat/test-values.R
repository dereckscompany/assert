...
test_that("whole number and empty string assertions work", {
  ...
  expect_invisible(assert_nonempty_strings(c("a", "b")))
  expect_error(assert_nonempty_strings(c("a", "")), "non-empty strings")
  expect_error(assert_nonempty_strings(c("a", NA)), "non-empty strings")
  expect_error(assert_nonempty_strings(1:3), "non-empty strings")
})
...
test_that("range, set and pattern assertions work", {
  ...
  expect_invisible(assert_value_in_set("a", c("a", "b", "c")))
  expect_error(assert_value_in_set("z", c("a", "b")), "be one of")
  expect_error(assert_value_in_set(c("a", "b"), c("a", "b")), "be one of")
